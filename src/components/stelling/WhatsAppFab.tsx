    ...
    <AnimatePresence>
      {visible && (
        <motion.div
          ...
          className="fixed z-[190] right-5 bottom-[88px] md:right-8 md:bottom-8"
          ...
          <AnimatePresence>
            {hover && (
              <motion.div
                ...
                exit={{ opacity: 0, x: 10 }}
                className="hidden md:block font-mono-ui absolute right-[64px] top-1/2 -translate-y-1/2 whitespace-nowrap"
                style={{
                  background: "#0D0F1C",
